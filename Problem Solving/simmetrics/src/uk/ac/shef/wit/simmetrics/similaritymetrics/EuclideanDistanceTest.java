...
public class EuclideanDistanceTest extends TestCase {
    ...
    private AbstractStringMetric metricqgram3;
    ...
    protected void setUp() {
        ...
        InterfaceTokeniser qgram3 = new TokeniserQGram3Extended();
        metricqgram3 = new EuclideanDistance(qgram3);
    ...
    public void testGetSimilarity() {
       ...
       // float result = metric.getSimilarity("Test String1", "Test String2");
        ...
        AbstractStringMetric metric1 = new EuclideanDistance(tokenizer);
        float result1 = metric1.getSimilarity("Test String1", "Test String2");
       float result2 = metric1.getSimilarity("Praneeth", "Proof");
